...
all:
	...
	$(DOCKER) run --rm -it -v $(CURDIR):$(PRJ_ROOT) $(KIBOT_IMAGE) kibot -c $(PRJ_ROOT)/xdevcan01/xdevcan01.kibot.yaml -e $(PRJ_ROOT)/xdevstm01/xdevcan01.kicad_sch -b $(PRJ_ROOT)/xdevcan01/xdevcan01.kicad_pcb -d $(OUT_DIR)/xdevcan01
